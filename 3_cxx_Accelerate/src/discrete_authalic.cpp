...
int main(int argc, char** argv)
{
  ...
  typedef CGAL::Accelerate_solver_traits<double> Solver_traits;
  typedef SMP::Circular_border_arc_length_parameterizer_3<SurfaceMesh>  Border_parameterizer;
  typedef SMP::Discrete_authalic_parameterizer_3<SurfaceMesh, Border_parameterizer, Solver_traits> Parameterizer;
